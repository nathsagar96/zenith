...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleIllegalArgumentException(IllegalArgumentException e) {
    ...
    ErrorResponse error = new ErrorResponse("BAD_REQUEST", e.getMessage(), Instant.now());
  ...
  public ResponseEntity<ErrorResponse> handleIllegalStateException(IllegalStateException e) {
    ...
    ErrorResponse error = new ErrorResponse("CONFLICT", e.getMessage(), Instant.now());
  ...
  public ResponseEntity<ErrorResponse> handleBadCredentialsException(BadCredentialsException e) {
    ...
    ErrorResponse error = new ErrorResponse("UNAUTHORIZED", "Invalid credentials", Instant.now());
  ...
  public ResponseEntity<ErrorResponse> handleInvalidTokenException(InvalidTokenException e) {
    ...
    ErrorResponse error = new ErrorResponse("UNAUTHORIZED", e.getMessage(), Instant.now());
    return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(error);
  }
  ...
  public ResponseEntity<ErrorResponse> handleGenericException(Exception e) {
    ...
    ErrorResponse error = new ErrorResponse("INTERNAL_SERVER_ERROR", e.getMessage(), Instant.now());
